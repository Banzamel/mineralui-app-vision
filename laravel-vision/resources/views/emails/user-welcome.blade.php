                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="560" style="max-width:560px; background:#ffffff; border-radius:18px; box-shadow:0 4px 12px rgba(4,6,12,0.08); overflow:hidden;">
                    <tr>
                        <td style="background:linear-gradient(135deg, #04060c 0%, #0a0e18 100%); padding:36px 40px; text-align:center;">
                            ...
                            @endif
                            <p style="margin:14px 0 0; color:#a8b2c8; font-size:13px; letter-spacing:0.04em; text-transform:uppercase;">Welcome — your account is ready</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:36px 40px;">
                            ...
                            <p style="margin:0 0 24px; font-size:15px; color:#374151;">
                                An account has been created for you. Sign in with the credentials below — please change the password under your profile after the first sign-in.
                            </p>
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background:#f9fafb; border:1px solid #e5e7eb; border-left:3px solid #44e7da; border-radius:10px; margin:0 0 28px;">
                                <tr>
                                    <td style="padding:22px 26px;">
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:0.08em; color:#6b7280;">Login</p>
                                        <p style="margin:0 0 18px; font-family:'JetBrains Mono', 'SFMono-Regular', Menlo, Consolas, monospace; font-size:15px; font-weight:600; color:#04060c;">{{ $userEmail }}</p>
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:0.08em; color:#6b7280;">Password</p>
                                        <p style="margin:0; font-family:'JetBrains Mono', 'SFMono-Regular', Menlo, Consolas, monospace; font-size:20px; font-weight:600; color:#04060c; letter-spacing:0.04em;">{{ $password }}</p>
                                    </td>
                                </tr>
                            </table>
                            @if($appUrl)
                            ...
                            <p style="margin:0; font-size:13px; color:#6b7280;">
                                Didn't expect this email? Contact your administrator.
                            </p>
                        </td>
                    </tr>
                    <tr>
