...
/**
 * Request validating data for the test connection check in the install wizard.
 */
final class TestDatabaseRequest extends FormRequest
{
    /**
     * The installer endpoint is public (works before any account is created).
     *
    ...
    /**
     * Builds a DTO with connection data from the request.
     *
